    ...
    return `
        <header class="top-nav glass-panel" role="banner">
            ...
            <div class="top-nav-right">
                ...
                <!-- Notifications -->
                <button class="nav-icon-btn" onclick="if(window.NotificationCenter) NotificationCenter.toggle()" aria-label="Notifications">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                        <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/>
                        <path d="M13.73 21a2 2 0 0 1-3.46 0"/>
                    </svg>
                    <span class="notification-badge" data-count="0"></span>
                </button>
